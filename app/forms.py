...
class RegistrationForm(FlaskForm):
    ...
    def validate_username(self, username):
        ...
        if user is not None:
            raise ValidationError(_('That username is taken. Please use a different username.'))
    
    def validate_email(self, email):
        user = User.query.filter_by(email=email.data).first()
        if user is not None:
            raise ValidationError(_('That email is taken. Please use a different email address.'))
